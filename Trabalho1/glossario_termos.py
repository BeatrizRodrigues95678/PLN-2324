...
filename = "GlossaÌrio de Termos MeÌdicos TeÌcnicos e Populares.xml"
...
resultado=open("glossario_inicial.txt", "w", encoding='UTF-8')
...
result=open("glossario.txt", "w", encoding='UTF-8')
result.write(texto2)
result.close()
